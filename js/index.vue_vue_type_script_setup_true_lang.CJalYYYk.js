import { d as defineComponent, g as createElementBlock, f as openBlock, r as ref, s as shallowRef, o as onMounted, I as watch, az as toRaw, R as watchEffect, bL as mergeModels, bM as useModel, aa as onBeforeUnmount, m as createVNode, i as unref, k as normalizeStyle } from "./index.Bbtf1pPU.js";
import { F as FileAPI } from "./file-api.vV6xJSHT.js";
...
function DS() {
  for (var e5, t2, n2, r2, o2, i2, a2, s2 = 1; eS.length; ) eS.length > s2 && eS.sort(rS), e5 = eS.shift(), s2 = eS.length, e5.__d && (n2 = void 0, r2 = void 0, o2 = (r2 = (t2 = e5).__v).__e, i2 = [], a2 = [], t2.__P && ((n2 = pS({}, r2)).__v = r2.__v + 1, Zw.vnode && Zw.vnode(n2), TS(t2.__P, n2, r2, t2.__n, t2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, i2, null == o2 ? bS(r2) : o2, !!(32 & r2.__u), a2), n2.__v = r2.__v, n2.__.__k[n2.__i] = n2, FS(i2, n2, a2), r2.__e = r2.__ = null, n2.__e != o2 && ES(n2)));
  DS.__r = 0;
}
